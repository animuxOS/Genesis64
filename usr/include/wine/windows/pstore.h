/*** Autogenerated by WIDL 1.0-rc1 from pstore.idl - Do not edit ***/
#include <rpc.h>
#include <rpcndr.h>
...
typedef struct __WIDL_pstore_generated_name_00000000 {
    DWORD cbSize;
    PST_ACCESSCLAUSETYPE ClauseType;
    DWORD cbClauseData;
    BYTE *pbClauseData;
} PST_ACCESSCLAUSE;
typedef struct __WIDL_pstore_generated_name_00000000 *PPST_ACCESSCLAUSE;
typedef struct __WIDL_pstore_generated_name_00000001 {
    DWORD cbSize;
    PST_ACCESSMODE AccessModeFlags;
    DWORD cClauses;
    PST_ACCESSCLAUSE *rgClauses;
} PST_ACCESSRULE;
typedef struct __WIDL_pstore_generated_name_00000001 *PPST_ACCESSRULE;
typedef struct __WIDL_pstore_generated_name_00000002 {
    DWORD cbSize;
    DWORD cClause;
    PST_ACCESSRULE *rgRules;
} PST_ACCESSRULESET;
typedef struct __WIDL_pstore_generated_name_00000002 *PPST_ACCESSRULESET;
typedef struct __WIDL_pstore_generated_name_00000003 {
    DWORD cbSize;
    LPWSTR szDisplayName;
} PST_TYPEINFO;
typedef struct __WIDL_pstore_generated_name_00000003 *PPST_TYPEINFO;
