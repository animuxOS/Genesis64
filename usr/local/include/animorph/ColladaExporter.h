...
protected:
   ...
   void WriteTriangle(int uno,int due,int tre,XMLNode &p,const Gen3D::Face face,int texture_counter,std::ostringstream &polygon_out_stream);
...
public:
 ...
 /*!
   ...
   */
  void setTransformationMatrix (Gen3D::Matrix &tm) {this->tm = tm;}
