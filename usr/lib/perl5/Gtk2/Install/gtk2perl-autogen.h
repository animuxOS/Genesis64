...
# define SvAtkObject_ornull(sv)	(((sv) && SvOK (sv)) ? SvAtkObject(sv) : NULL)
...
# define SvGdkColor(sv)	(gperl_get_boxed_check ((sv), GDK_TYPE_COLOR))
# define SvGdkColor_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkColor (sv) : NULL)
...
# define SvGdkColormap_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkColormap(sv) : NULL)
...
# define SvGdkCursor(sv)	(gperl_get_boxed_check ((sv), GDK_TYPE_CURSOR))
# define SvGdkCursor_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkCursor (sv) : NULL)
...
# define SvGdkDevice_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkDevice(sv) : NULL)
...
# define SvGdkDragContext_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkDragContext(sv) : NULL)
...
# define SvGdkDrawable_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkDrawable(sv) : NULL)
...
# define SvGdkEvent(sv)	(gperl_get_boxed_check ((sv), GDK_TYPE_EVENT))
# define SvGdkEvent_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkEvent (sv) : NULL)
...
# define SvGdkFont(sv)	(gperl_get_boxed_check ((sv), GDK_TYPE_FONT))
# define SvGdkFont_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkFont (sv) : NULL)
...
# define SvGdkGC_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkGC(sv) : NULL)
...
# define SvGdkImage_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkImage(sv) : NULL)
...
# define SvGdkKeymap_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkKeymap(sv) : NULL)
...
# define SvGdkPixbufAnimation_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkPixbufAnimation(sv) : NULL)
...
# define SvGdkPixbufAnimationIter_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkPixbufAnimationIter(sv) : NULL)
...
# define SvGdkPixbuf_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkPixbuf(sv) : NULL)
...
# define SvGdkPixbufLoader_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkPixbufLoader(sv) : NULL)
...
# define SvGdkPixmap_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkPixmap(sv) : NULL)
...
# define SvGdkRectangle(sv)	(gperl_get_boxed_check ((sv), GDK_TYPE_RECTANGLE))
# define SvGdkRectangle_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkRectangle (sv) : NULL)
...
# define SvGdkVisual_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkVisual(sv) : NULL)
...
# define SvGdkWindow_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkWindow(sv) : NULL)
...
# define SvGtkAccelGroup_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkAccelGroup(sv) : NULL)
...
# define SvGtkAccelLabel_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkAccelLabel(sv) : NULL)
...
# define SvGtkAccessible_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkAccessible(sv) : NULL)
...
# define SvGtkAdjustment_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkAdjustment(sv) : NULL)
...
# define SvGtkAlignment_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkAlignment(sv) : NULL)
...
# define SvGtkArrow_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkArrow(sv) : NULL)
...
# define SvGtkAspectFrame_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkAspectFrame(sv) : NULL)
...
# define SvGtkBin_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkBin(sv) : NULL)
...
# define SvGtkBorder_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkBorder (sv) : NULL)
...
# define SvGtkBox_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkBox(sv) : NULL)
...
# define SvGtkButtonBox_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkButtonBox(sv) : NULL)
...
# define SvGtkButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkButton(sv) : NULL)
...
# define SvGtkCalendar_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCalendar(sv) : NULL)
...
# define SvGtkCellEditable_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellEditable(sv) : NULL)
...
# define SvGtkCellRenderer_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellRenderer(sv) : NULL)
...
# define SvGtkCellRendererPixbuf_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellRendererPixbuf(sv) : NULL)
...
# define SvGtkCellRendererText_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellRendererText(sv) : NULL)
...
# define SvGtkCellRendererToggle_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellRendererToggle(sv) : NULL)
...
# define SvGtkCheckButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCheckButton(sv) : NULL)
...
# define SvGtkCheckMenuItem_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCheckMenuItem(sv) : NULL)
...
# define SvGtkColorSelectionDialog_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkColorSelectionDialog(sv) : NULL)
...
# define SvGtkColorSelection_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkColorSelection(sv) : NULL)
...
# define SvGtkCombo_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCombo(sv) : NULL)
...
# define SvGtkContainer_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkContainer(sv) : NULL)
...
# define SvGtkCurve_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCurve(sv) : NULL)
...
# define SvGtkDialog_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkDialog(sv) : NULL)
...
# define SvGtkDrawingArea_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkDrawingArea(sv) : NULL)
...
# define SvGtkEditable_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkEditable(sv) : NULL)
...
# define SvGtkEntry_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkEntry(sv) : NULL)
...
# define SvGtkEventBox_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkEventBox(sv) : NULL)
...
# define SvGtkFileSelection_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFileSelection(sv) : NULL)
...
# define SvGtkFixed_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFixed(sv) : NULL)
...
# define SvGtkFontSelectionDialog_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFontSelectionDialog(sv) : NULL)
...
# define SvGtkFontSelection_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFontSelection(sv) : NULL)
...
# define SvGtkFrame_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFrame(sv) : NULL)
...
# define SvGtkGammaCurve_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkGammaCurve(sv) : NULL)
...
# define SvGtkHandleBox_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkHandleBox(sv) : NULL)
...
# define SvGtkHBox_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkHBox(sv) : NULL)
...
# define SvGtkHButtonBox_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkHButtonBox(sv) : NULL)
...
# define SvGtkHPaned_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkHPaned(sv) : NULL)
...
# define SvGtkHRuler_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkHRuler(sv) : NULL)
...
# define SvGtkHScale_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkHScale(sv) : NULL)
...
# define SvGtkHScrollbar_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkHScrollbar(sv) : NULL)
...
# define SvGtkHSeparator_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkHSeparator(sv) : NULL)
...
# define SvGtkIconFactory_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkIconFactory(sv) : NULL)
...
# define SvGtkIconSet(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_ICON_SET))
# define SvGtkIconSet_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkIconSet (sv) : NULL)
...
# define SvGtkIconSource(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_ICON_SOURCE))
# define SvGtkIconSource_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkIconSource (sv) : NULL)
...
# define SvGtkImage_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkImage(sv) : NULL)
...
# define SvGtkImageMenuItem_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkImageMenuItem(sv) : NULL)
...
# define SvGtkIMContext_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkIMContext(sv) : NULL)
...
# define SvGtkIMContextSimple_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkIMContextSimple(sv) : NULL)
...
# define SvGtkIMMulticontext_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkIMMulticontext(sv) : NULL)
...
# define SvGtkInputDialog_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkInputDialog(sv) : NULL)
...
# define SvGtkInvisible_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkInvisible(sv) : NULL)
...
# define SvGtkItemFactory_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkItemFactory(sv) : NULL)
...
# define SvGtkItem_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkItem(sv) : NULL)
...
# define SvGtkLabel_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkLabel(sv) : NULL)
...
# define SvGtkLayout_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkLayout(sv) : NULL)
...
# define SvGtkList_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkList(sv) : NULL)
...
# define SvGtkListItem_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkListItem(sv) : NULL)
...
# define SvGtkListStore_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkListStore(sv) : NULL)
...
# define SvGtkMenuBar_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkMenuBar(sv) : NULL)
...
# define SvGtkMenu_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkMenu(sv) : NULL)
...
# define SvGtkMenuItem_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkMenuItem(sv) : NULL)
...
# define SvGtkMenuShell_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkMenuShell(sv) : NULL)
...
# define SvGtkMessageDialog_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkMessageDialog(sv) : NULL)
...
# define SvGtkMisc_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkMisc(sv) : NULL)
...
# define SvGtkNotebook_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkNotebook(sv) : NULL)
...
# define SvGtkObject_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkObject(sv) : NULL)
...
# define SvGtkOptionMenu_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkOptionMenu(sv) : NULL)
...
# define SvGtkPaned_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkPaned(sv) : NULL)
...
# define SvGtkPlug_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkPlug(sv) : NULL)
...
# define SvGtkProgressBar_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkProgressBar(sv) : NULL)
...
# define SvGtkRadioButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRadioButton(sv) : NULL)
...
# define SvGtkRadioMenuItem_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRadioMenuItem(sv) : NULL)
...
# define SvGtkRange_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRange(sv) : NULL)
...
# define SvGtkRcStyle_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRcStyle(sv) : NULL)
...
# define SvGtkRequisition(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_REQUISITION))
# define SvGtkRequisition_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRequisition (sv) : NULL)
...
# define SvGtkRuler_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRuler(sv) : NULL)
...
# define SvGtkScale_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkScale(sv) : NULL)
...
# define SvGtkScrollbar_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkScrollbar(sv) : NULL)
...
# define SvGtkScrolledWindow_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkScrolledWindow(sv) : NULL)
...
# define SvGtkSelectionData(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_SELECTION_DATA))
# define SvGtkSelectionData_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkSelectionData (sv) : NULL)
...
# define SvGtkSeparator_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkSeparator(sv) : NULL)
...
# define SvGtkSeparatorMenuItem_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkSeparatorMenuItem(sv) : NULL)
...
# define SvGtkSettings_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkSettings(sv) : NULL)
...
# define SvGtkSizeGroup_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkSizeGroup(sv) : NULL)
...
# define SvGtkSocket_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkSocket(sv) : NULL)
...
# define SvGtkSpinButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkSpinButton(sv) : NULL)
...
# define SvGtkStatusbar_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkStatusbar(sv) : NULL)
...
# define SvGtkStyle_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkStyle(sv) : NULL)
...
# define SvGtkTable_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTable(sv) : NULL)
...
# define SvGtkTearoffMenuItem_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTearoffMenuItem(sv) : NULL)
...
# define SvGtkTextAttributes(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_TEXT_ATTRIBUTES))
# define SvGtkTextAttributes_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTextAttributes (sv) : NULL)
...
# define SvGtkTextBuffer_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTextBuffer(sv) : NULL)
...
# define SvGtkTextChildAnchor_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTextChildAnchor(sv) : NULL)
...
# define SvGtkTextIter(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_TEXT_ITER))
# define SvGtkTextIter_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTextIter (sv) : NULL)
...
# define SvGtkTextMark_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTextMark(sv) : NULL)
...
# define SvGtkTextTag_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTextTag(sv) : NULL)
...
# define SvGtkTextTagTable_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTextTagTable(sv) : NULL)
...
# define SvGtkTextView_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTextView(sv) : NULL)
...
# define SvGtkToggleButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkToggleButton(sv) : NULL)
...
# define SvGtkToolbar_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkToolbar(sv) : NULL)
...
# define SvGtkTooltips_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTooltips(sv) : NULL)
...
# define SvGtkTreeDragDest_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeDragDest(sv) : NULL)
...
# define SvGtkTreeDragSource_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeDragSource(sv) : NULL)
...
# define SvGtkTreeIter(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_TREE_ITER))
# define SvGtkTreeIter_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeIter (sv) : NULL)
...
# define SvGtkTreeModel_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeModel(sv) : NULL)
...
# define SvGtkTreeModelSort_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeModelSort(sv) : NULL)
...
# define SvGtkTreePath(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_TREE_PATH))
# define SvGtkTreePath_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreePath (sv) : NULL)
...
# define SvGtkTreeRowReference(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_TREE_ROW_REFERENCE))
# define SvGtkTreeRowReference_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeRowReference (sv) : NULL)
...
# define SvGtkTreeSelection_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeSelection(sv) : NULL)
...
# define SvGtkTreeSortable_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeSortable(sv) : NULL)
...
# define SvGtkTreeStore_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeStore(sv) : NULL)
...
# define SvGtkTreeViewColumn_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeViewColumn(sv) : NULL)
...
# define SvGtkTreeView_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeView(sv) : NULL)
...
# define SvGtkVBox_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkVBox(sv) : NULL)
...
# define SvGtkVButtonBox_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkVButtonBox(sv) : NULL)
...
# define SvGtkViewport_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkViewport(sv) : NULL)
...
# define SvGtkVPaned_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkVPaned(sv) : NULL)
...
# define SvGtkVRuler_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkVRuler(sv) : NULL)
...
# define SvGtkVScale_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkVScale(sv) : NULL)
...
# define SvGtkVScrollbar_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkVScrollbar(sv) : NULL)
...
# define SvGtkVSeparator_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkVSeparator(sv) : NULL)
...
# define SvGtkWidget_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkWidget(sv) : NULL)
...
# define SvGtkWindowGroup_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkWindowGroup(sv) : NULL)
...
# define SvGtkWindow_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkWindow(sv) : NULL)
...
# define SvGdkRegion(sv)	(gperl_get_boxed_check ((sv), GDK_TYPE_REGION))
# define SvGdkRegion_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkRegion (sv) : NULL)
...
# define SvGtkAssistant_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkAssistant(sv) : NULL)
...
# define SvGtkCellRendererAccel_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellRendererAccel(sv) : NULL)
...
# define SvGtkCellRendererSpin_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellRendererSpin(sv) : NULL)
...
# define SvGtkLinkButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkLinkButton(sv) : NULL)
...
# define SvGtkPageSetup_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkPageSetup(sv) : NULL)
...
# define SvGtkPaperSize(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_PAPER_SIZE))
# define SvGtkPaperSize_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkPaperSize (sv) : NULL)
...
# define SvGtkPrintContext_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkPrintContext(sv) : NULL)
...
# define SvGtkPrintOperation_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkPrintOperation(sv) : NULL)
...
# define SvGtkPrintOperationPreview_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkPrintOperationPreview(sv) : NULL)
...
# define SvGtkPrintSettings_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkPrintSettings(sv) : NULL)
...
# define SvGtkRecentChooser_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRecentChooser(sv) : NULL)
...
# define SvGtkRecentChooserDialog_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRecentChooserDialog(sv) : NULL)
...
# define SvGtkRecentChooserMenu_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRecentChooserMenu(sv) : NULL)
...
# define SvGtkRecentChooserWidget_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRecentChooserWidget(sv) : NULL)
...
# define SvGtkRecentFilter_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRecentFilter(sv) : NULL)
...
# define SvGtkRecentInfo(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_RECENT_INFO))
# define SvGtkRecentInfo_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRecentInfo (sv) : NULL)
...
# define SvGtkRecentManager_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRecentManager(sv) : NULL)
...
# define SvGtkStatusIcon_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkStatusIcon(sv) : NULL)
...
# define SvGtkTargetList(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_TARGET_LIST))
...
# define SvGdkDisplay_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkDisplay(sv) : NULL)
...
# define SvGdkDisplayManager_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkDisplayManager(sv) : NULL)
...
# define SvGdkScreen_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkScreen(sv) : NULL)
...
# define SvGtkClipboard_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkClipboard(sv) : NULL)
...
# define SvGtkComboBoxEntry_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkComboBoxEntry(sv) : NULL)
...
# define SvGtkComboBox_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkComboBox(sv) : NULL)
...
# define SvGtkCellLayout_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellLayout(sv) : NULL)
...
# define SvGtkColorButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkColorButton(sv) : NULL)
...
# define SvGtkFontButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFontButton(sv) : NULL)
...
# define SvGtkEntryCompletion_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkEntryCompletion(sv) : NULL)
...
# define SvGtkExpander_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkExpander(sv) : NULL)
...
# define SvGtkFileChooser_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFileChooser(sv) : NULL)
...
# define SvGtkFileChooserDialog_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFileChooserDialog(sv) : NULL)
...
# define SvGtkFileChooserWidget_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFileChooserWidget(sv) : NULL)
...
# define SvGtkFileFilter_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFileFilter(sv) : NULL)
...
# define SvGtkFileFilterInfo(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_FILE_FILTER_INFO))
# define SvGtkFileFilterInfo_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFileFilterInfo (sv) : NULL)
...
# define SvGtkIconTheme_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkIconTheme(sv) : NULL)
...
# define SvGtkIconInfo(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_ICON_INFO))
# define SvGtkIconInfo_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkIconInfo (sv) : NULL)
...
# define SvGtkTreeModelFilter_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkTreeModelFilter(sv) : NULL)
...
# define SvGtkUIManager_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkUIManager(sv) : NULL)
...
# define SvGtkActionGroup_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkActionGroup(sv) : NULL)
...
# define SvGtkAction_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkAction(sv) : NULL)
...
# define SvGtkToggleAction_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkToggleAction(sv) : NULL)
...
# define SvGtkRadioAction_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRadioAction(sv) : NULL)
...
# define SvGtkActionEntry(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_ACTION_ENTRY))
# define SvGtkActionEntry_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkActionEntry (sv) : NULL)
...
# define SvGtkToggleActionEntry(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_TOGGLE_ACTION_ENTRY))
# define SvGtkToggleActionEntry_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkToggleActionEntry (sv) : NULL)
...
# define SvGtkRadioActionEntry(sv)	(gperl_get_boxed_check ((sv), GTK_TYPE_RADIO_ACTION_ENTRY))
# define SvGtkRadioActionEntry_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRadioActionEntry (sv) : NULL)
...
# define SvGtkToolItem_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkToolItem(sv) : NULL)
...
# define SvGtkToolButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkToolButton(sv) : NULL)
...
# define SvGtkToggleToolButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkToggleToolButton(sv) : NULL)
...
# define SvGtkRadioToolButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkRadioToolButton(sv) : NULL)
...
# define SvGtkSeparatorToolItem_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkSeparatorToolItem(sv) : NULL)
...
# define SvGtkAccelMap_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkAccelMap(sv) : NULL)
...
# define SvGtkAboutDialog_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkAboutDialog(sv) : NULL)
...
# define SvGtkCellRendererCombo_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellRendererCombo(sv) : NULL)
...
# define SvGtkCellRendererProgress_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellRendererProgress(sv) : NULL)
...
# define SvGtkCellView_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkCellView(sv) : NULL)
...
# define SvGtkFileChooserButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkFileChooserButton(sv) : NULL)
...
# define SvGtkIconView_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkIconView(sv) : NULL)
...
# define SvGtkMenuToolButton_ornull(sv)	(((sv) && SvOK (sv)) ? SvGtkMenuToolButton(sv) : NULL)
...
# define SvGdkPangoRenderer_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkPangoRenderer(sv) : NULL)
...
# define SvGdkPixbufSimpleAnim_ornull(sv)	(((sv) && SvOK (sv)) ? SvGdkPixbufSimpleAnim(sv) : NULL)
...
# define SvPangoAttrList(sv)	(gperl_get_boxed_check ((sv), PANGO_TYPE_ATTR_LIST))
# define SvPangoAttrList_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoAttrList (sv) : NULL)
...
# define SvPangoColor(sv)	(gperl_get_boxed_check ((sv), PANGO_TYPE_COLOR))
# define SvPangoColor_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoColor (sv) : NULL)
...
# define SvPangoContext_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoContext(sv) : NULL)
...
# define SvPangoFontDescription(sv)	(gperl_get_boxed_check ((sv), PANGO_TYPE_FONT_DESCRIPTION))
# define SvPangoFontDescription_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoFontDescription (sv) : NULL)
...
# define SvPangoFontFace_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoFontFace(sv) : NULL)
...
# define SvPangoFontFamily_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoFontFamily(sv) : NULL)
...
# define SvPangoFontMap_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoFontMap(sv) : NULL)
...
# define SvPangoFontMetrics(sv)	(gperl_get_boxed_check ((sv), PANGO_TYPE_FONT_METRICS))
# define SvPangoFontMetrics_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoFontMetrics (sv) : NULL)
...
# define SvPangoFont_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoFont(sv) : NULL)
...
# define SvPangoFontset_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoFontset(sv) : NULL)
...
# define SvPangoGlyphString(sv)	(gperl_get_boxed_check ((sv), PANGO_TYPE_GLYPH_STRING))
# define SvPangoGlyphString_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoGlyphString (sv) : NULL)
...
# define SvPangoLanguage(sv)	(gperl_get_boxed_check ((sv), PANGO_TYPE_LANGUAGE))
# define SvPangoLanguage_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoLanguage (sv) : NULL)
...
# define SvPangoLayout_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoLayout(sv) : NULL)
...
# define SvPangoTabArray(sv)	(gperl_get_boxed_check ((sv), PANGO_TYPE_TAB_ARRAY))
# define SvPangoTabArray_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoTabArray (sv) : NULL)
...
# define SvPangoLayoutIter(sv)	(gperl_get_boxed_check ((sv), PANGO_TYPE_LAYOUT_ITER))
# define SvPangoLayoutIter_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoLayoutIter (sv) : NULL)
...
# define SvPangoCairoFontMap_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoCairoFontMap(sv) : NULL)
...
# define SvPangoScriptIter(sv)	(gperl_get_boxed_check ((sv), PANGO_TYPE_SCRIPT_ITER))
# define SvPangoScriptIter_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoScriptIter (sv) : NULL)
...
# define SvPangoMatrix(sv)	(gperl_get_boxed_check ((sv), PANGO_TYPE_MATRIX))
# define SvPangoMatrix_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoMatrix (sv) : NULL)
...
# define SvPangoRenderer_ornull(sv)	(((sv) && SvOK (sv)) ? SvPangoRenderer(sv) : NULL)
