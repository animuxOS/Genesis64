...
def fillTemplate(domHandler, dtvPlatform, eventCookie, bodyTagExtra, *args, **kargs):
    ...
    def up_0_handle_0(viewName, view, tid):
        ...
        out.seek(0)
        return out
    handle_0.addUpdate('tmplcomp19576927','nextSibling',thisItemView,up_0_handle_0, u'thisItemView')
    ...
    out.write(_(u'Miro - External Playback Template'))
    out.write(u'</title>\n\n    <link href="')
    ...
    out.write(quoteattr(urlencode(this.getID())))
    out.write(u')" id="external-button-center">\n            <span>')
    out.write(_(u'Continue To Next Video'))
    out.write(u'</span>\n        </a>\n    </div>\n    <div id="embedded-video-info">\n        <div id="video_info_area">')
    out.write(u'\n<div id="videodetails-container">\n')
    out.write(u'<span id="tmplcomp19576927"/>\n\t<div id="videodetails-channeltitle">\n        <h1>')
