...
def fillTemplate(domHandler, dtvPlatform, eventCookie, bodyTagExtra, *args, **kargs):
    ...
    if not (not (selectedFolders > 0)):
        ...
        tmplcomp44664954 = {}
        tmplcomp66175425 = StringIO()
        tmplcomp66175425.write(u'<span>')
        tmplcomp66175425.write(escape(selectedFolders))
        tmplcomp66175425.write(u'</span>')
        tmplcomp66175425.seek(0)
        tmplcomp44664954['count'] = tmplcomp66175425.read()
        tmplcomp63974009 = StringIO()
        tmplcomp63974009.write(u'<span>')
        tmplcomp63974009.write(escape(containedChildren))
        tmplcomp63974009.write(u'</span>')
        tmplcomp63974009.seek(0)
        tmplcomp44664954['containedcount'] = tmplcomp63974009.read()
        out.write(Template(_(u'${count} Playlist Folders Selected<br></br>(contains ${containedcount} playlists)')).substitute(tmplcomp44664954))
        out.write(u'</div>\n        </div>')
    out.write(u'\n        \n        ')
    if not (not (selectedChildren > 0)):
        out.write(u'<div>\n            <div class="channel-message">')
        tmplcomp47838704 = {}
        tmplcomp24816826 = StringIO()
        tmplcomp24816826.write(u'<span>')
        tmplcomp24816826.write(escape(selectedChildren))
        tmplcomp24816826.write(u'</span>')
        tmplcomp24816826.seek(0)
        tmplcomp47838704['count'] = tmplcomp24816826.read()
        out.write(Template(_(u'${count} Playlists Selected')).substitute(tmplcomp47838704))
        out.write(u'</div>\n        </div>')
    out.write(u'\n        <br></br><br></br><br></br>\n\n        ')
    if not (selectedFolders > 0):
        out.write(u'<div>\n        <div class="button-zone-two">\n            <div class="gray-button-wrap">\n                <div class="gray-button-bg" onclick="return eventURL(\'action:mergeToFolder\');">\n                    <div class="gray-button-left"></div>\n                    <div class="gray-button-right"></div>\n                    <div class="gray-button-content">Put Into a New Folder</div>\n                </div>\n            </div>\n            <div class="gray-button-wrap">\n                    <div class="gray-button-bg" onclick="return eventURL(\'action:removeCurrentPlaylist\');">\n                        <div class="gray-button-left"></div>\n                        <div class="gray-button-right"></div>\n                        <div class="gray-button-content">Delete</div>\n                    </div>\n            </div>\n        </div>\n        </div>')
    out.write(u'\n        ')
    if not (not (selectedFolders > 0)):
