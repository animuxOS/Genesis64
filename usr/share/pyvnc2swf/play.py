...
##  pyvnc2swf - play.py
##
##  $Id: play.py,v 1.2 2007/04/25 16:55:25 euske Exp $
##
...
if __name__ == "__main__":
  import getopt, re
  def usage():
    print >>stderr, '''usage: play.py [-d] [-r framerate] [-C WxH+X+Y] [-s scaling] file1 file2 ...'''
    sys.exit(2)
  try:
    (opts, args) = getopt.getopt(sys.argv[1:], 'dr:C:s:')
