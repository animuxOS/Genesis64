...
var nsCeltxContentHandler = {
  ...
  handle : function cch_handle(cmdLine) {
    // This used to work on Linux, then stopped. Let's assume we're always Celtx.
    if (true || cmdLine.handleFlag("celtx", false)) {
  ...
  getFeatures : function cch_features(cmdLine) {
...
var nsDefaultCommandLineHandler = {
  ...
  _handledURIs: [ ],
//@line 309 "/home/tony/Development/celtx/mozilla/celtx/components/nsCeltxContentHandler.js"

  /* nsICommandLineHandler */
  handle : function dch_handle(cmdLine) {
    var urilist = [];

//@line 335 "/home/tony/Development/celtx/mozilla/celtx/components/nsCeltxContentHandler.js"
      ...
      if (speclist.length > 0) {
        ...
        for (var i = 0; i < speclist.length; ++i) {
          ...
          if (! (fileurl instanceof IFileURL)) {
            dump("*** Can't open non-file url: " + speclist[i] + "\n");
            continue;
          }
        ...
        if (speclist.length > 0) {
          openWindow(null, nsCeltxContentHandler.chromeURL, "_blank",
                     ...
                     + nsCeltxContentHandler.getFeatures(cmdLine),
                     speclist.join("|"));
